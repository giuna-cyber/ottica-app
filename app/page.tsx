    ...
    <main className="min-h-screen bg-[var(--app-background)] pb-24 text-[var(--app-text-soft)]">
      ...
      <section className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
        ...
        <div className="mt-7 grid gap-4 sm:grid-cols-3">
          <Link
            href="/catalogo"
            className="group relative min-h-[220px] overflow-hidden rounded-[22px] border border-[var(--app-border-strong)] bg-[#E5EEEA] p-5 shadow-[0_14px_34px_rgba(42,78,75,.08)]"
          >
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_78%_18%,rgba(255,255,255,.8),transparent_33%),linear-gradient(145deg,#EDF3F0,#D2E2DD)]" />
            <div className="relative flex h-full flex-col">
              <div className="flex h-11 w-11 items-center justify-center rounded-full border border-[#6F918B]/20 bg-[var(--app-surface)]/90 text-[var(--app-primary-hover)]">
                <IconaCatalogoOttica />
              </div>
          ...
          <Link
            href="/appuntamenti"
            className="group relative min-h-[220px] overflow-hidden rounded-[22px] border border-[#D7E0DD] bg-[#E7EEEB] p-5 shadow-[0_14px_34px_rgba(42,78,75,.08)]"
          >
            <div className="absolute inset-0 bg-[linear-gradient(145deg,#F3F4F0,#DCE5E1)]" />
            <div className="relative flex h-full flex-col">
              <div className="flex h-11 w-11 items-center justify-center rounded-full border border-[#6F918B]/20 bg-[var(--app-surface)]/90 text-[var(--app-primary-hover)]">
                <IconaPrenotaOttica />
              </div>
          ...
          <Link
            href="/promozioni"
            className="group relative min-h-[220px] overflow-hidden rounded-[22px] border border-[#DEDCD4] bg-[#EEEAE2] p-5 shadow-[0_14px_34px_rgba(42,78,75,.08)]"
          >
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_82%_16%,rgba(255,255,255,.75),transparent_36%),linear-gradient(145deg,#F3F0EA,#E4E6DE)]" />
            <div className="relative flex h-full flex-col">
              <div className="flex h-11 w-11 items-center justify-center rounded-full border border-[#7E8F89]/20 bg-[var(--app-surface)]/90 text-[#6E8C86]">
                <IconaPromoOttica />
              </div>
              <div className="mt-auto">
